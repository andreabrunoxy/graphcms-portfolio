...
export default function Home({ data }) {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <Hero />
      <div className="mx-2 grid lg:grid-cols-12 gap-6">
        {/*Porftolio Section*/}
        <div className="px-4 lg:px-0 lg:col-span-9">
        ...
        {/*Blog Section*/}
        <div className="container mx-auto lg:col-span-3">
          <Fade triggerOnce>
            <div className="mt-10 border border-gray-200 shadow-lg px-2">
              <h2 className="text-4xl font-semibold text-gray-900 pt-8 px-2 mb-8">
                Recent Posts
              </h2>
              {data.posts.map(post => (
                <div key={post.slug}>
                  <Fade triggerOnce cascade fraction={0.3}>
                    <div className="py-2">
                      ...
                      <div className="col-span-3 p-4 flex flex-col place-items-start mt-2 after:inline-block border-b border-gray-200 mb-8 w-full last:after:hidden">
